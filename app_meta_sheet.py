...
# Chaves de API (Puxa do Render, não escreva aqui)
...
def send_whatsapp_message(to_number, message):
    ...
    # Se for Brasil (55) e tiver 12 dígitos (Ex: 55 75 9223 8338), falta o 9.
    if clean_number.startswith("55") and len(clean_number) == 12:
        clean_number = clean_number[:4] + "9" + clean_number[4:]
        logger.info(f"Número corrigido para envio: {clean_number}")
            ...
            for entry in body.get("entry", []):
                for change in entry.get("changes", []):
                    ...
                    if "messages" in value:
                        ...
                        # Garante que é mensagem de texto
                        if message["type"] == "text":
                            ...
                            logger.info("Recebi algo que não é texto.")
